...
type AppSpinnerType = "full" | "fixed" | "screen" | "default";
type AppSpinnerProps = ComponentProps<typeof Spinner> & {
	type?: AppSpinnerType;
};

const containerClasses: Record<AppSpinnerType, string> = {
	screen: "flex h-dvh w-dvw items-center justify-center",
	full: "flex-1 flex size-full items-center justify-center",
